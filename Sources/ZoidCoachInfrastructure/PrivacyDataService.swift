    ...
    public func storedDataInventory() throws -> PrivacyStoredDataInventory {
        let definitions: [(String, String, String, [String])] = [
            ...
            (
                ...
                ["daily_review_corrections", "daily_review_session_merges", "daily_reviews", "weekly_review_experiments", "app_classification_correction_rules", "learning_samples", "learning_aggregates", "planner_trust_cycles"]
            ),
