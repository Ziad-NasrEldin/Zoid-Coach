...
ROOT="${0:A:h:h}"
QA_ROOT="/private/tmp/zoid-666-qa-reminder-completion-sync-$PPID"
PACKAGED_APP="$ROOT/.build/app-qa/Zoid 666 QA.app"
INSTALLED_APP="$HOME/Applications/Zoid 666 QA Completion Sync Probe.app"
...
"$INSTALLED_APP/Contents/MacOS/ZoidCoachQA" \
    --qa-reminder-completion-sync-xpc-probe
print "PASS: packaged QA Reminder completion sync XPC lifecycle probe exited successfully"
