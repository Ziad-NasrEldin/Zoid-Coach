...
readonly REVIEWED_BASE="15d8e6ec42bf178e9de2ee055dd6915c8c74b786"
...
98a9b561c0c9d0cb39ac16f00fe11b5cebb0cd59 docs/ZC-035-011-SIGNED-QA-RUNBOOK.md"
...
verify_reviewed_lineage() {
    ...
    local head reviewed_scope scope commit_count head_scope patch_ids commit entry expected_blob file_path actual_blob
    ...
    [[ "$head_scope" == 'Scripts/qa-zc035011-signed-preflight.sh' ]] \
