...
readonly REVIEWED_BASE="b97c2ce3177ccf89f60225c475062608db1920ad"
readonly REVIEWED_LINEAGE_TIP="a75f52b31ca0a7b65651d770b1dc6b3826fbb77c"
...
verify_reviewed_lineage() {
    ...
    expected_parent_line="$REVIEWED_LINEAGE_TIP"
