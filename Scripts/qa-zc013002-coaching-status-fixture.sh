...
self_test() {
    local root=/private/tmp/zoid-zc013002-fixture-selftest-$$ snapshot=/private/tmp/zoid-zc013002-fixture-snapshot-$$ before
    ...
    print -- "PASS: ZC-013-002 fixture path safety and byte restoration self-test"
}
