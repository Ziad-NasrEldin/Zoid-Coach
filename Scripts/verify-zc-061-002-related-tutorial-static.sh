...
require_text Scripts/qa-zc061002-related-tutorial-fixture.sh "exact Today snapshot restoration"
require_text Scripts/qa-zc061002-related-tutorial-fixture.sh "chmod 600"
...
require_text docs/ZC-061-002-SIGNED-QA-RUNBOOK.md 'RESTORE_STATE="/private/tmp/zc061002/zc061002-today-snapshot-restore.sql"'
