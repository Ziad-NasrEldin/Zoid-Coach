...
The hard ten-minute cap arrived after the helper prerequisite was prepared but before the real-helper suppression probe ran.
...
- Real-helper `gamingIsUnlocked` suppression was not run before the hard cap.
...
- No current-tip claim is made for suppression outcome, prompt count, delivery count, or QA OS-notification count.
