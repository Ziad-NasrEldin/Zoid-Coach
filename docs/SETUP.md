# Zoid 666 setup and operations

Engineer runbook moved off the landing README. Product specs and scenario docs stay alongside this file in `docs/`.
...
See [Zoid Voice architecture and operation](ZOID-VOICE.md) for the tool, privacy, and runtime contracts.
...
- [Autonomous coach specification](AUTONOMOUS-COACH-SPEC.md)
- [Autonomous coach implementation plan](AUTONOMOUS-COACH-IMPLEMENTATION-PLAN.md)
- [Daily dashboard agent delta](DAILY-DASHBOARD-AGENT-DELTA.md)
- [Full product specification](ZOID-COACH-PRODUCT-SPEC.md)
- [MVP specification](ZOID-COACH-MVP.md)
- [Visual MVP specification](zoid-coach-mvp.html)
