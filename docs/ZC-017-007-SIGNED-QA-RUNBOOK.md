...
The current canonical base is `91197544123ccd53a647933545728af7ff81acd5`.
The reviewed product candidate is `a477c93a34dbf568e7d8053f1bc0ce55fe745442`.
The reviewed tooling candidate is `b2103974b9948660fcb3c5bb10c3e86e8e8c73c0`.
The product stable patch ID is `bfd7e82fdd3554ce9c7223e60a824d9e29d24566`.
The tooling stable patch ID is `c1bb138a61e771e6ec674063e3da0b59c7347090`.
...
The probe may perform a bounded physical scroll before the initial reading when lazy Today content is below the viewport.
The initial semantic reading has a bounded thirty-second readiness budget for a cold signed launch.
It requires one exact accessibility label and value pair plus measured content movement before accepting that initial reading.
The probe then allows one full minute boundary, rejects regressions on every poll, and requires an exact one-minute increment without clicking, navigating, refreshing, or scrolling again.
