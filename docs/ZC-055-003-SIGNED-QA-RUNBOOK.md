...
The product lineage includes the original keyboard lifecycle candidate `47f7ac0e98a5671894ec51dcd887c95a4c44a86d` and the production-snapshot switch correction `566482f23fb0c3f92460d3e1faec15af024f8723`.
...
git merge-base --is-ancestor 47f7ac0e98a5671894ec51dcd887c95a4c44a86d "$EXPECTED_SIGNED_COMMIT"
git merge-base --is-ancestor 566482f23fb0c3f92460d3e1faec15af024f8723 "$EXPECTED_SIGNED_COMMIT"
"$PREFLIGHT" --self-test
...
The preflight requires exactly the reviewed two product files and four verifier files relative to canonical base `ed5d07a363e0f64049c07b0e1d309d754caa035b`.
