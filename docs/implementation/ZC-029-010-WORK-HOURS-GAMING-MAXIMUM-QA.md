...
Set the value to 60 and run the probe with `settings-upper-bound`.
...
Include an overnight window whose after-midnight portion belongs to the selected start weekday.
