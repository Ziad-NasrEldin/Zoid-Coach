...
| 5 | Finish Reminders permission grant, denial, repair, and recovery UX | active | Reminders outage continuity lane `codex/reminders-outage-continuity` | `ZC-051-001` and `ZC-051-004`; owned files are Today continuity presentation, continuity state, one deterministic restart journey, focused tests, and candidate evidence |
