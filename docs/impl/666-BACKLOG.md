...
| 14 | Complete daily-plan task lifecycle | verify | Custom estimate candidate at `edc4e5e` | `ZC-011-006` and `ZC-011-007`; keyboard submission, bounded minute validation, exact errors, cancellation, durable estimate callback, and focused proof are recorded in `.audit/runs/custom-task-estimate/candidate/REPORT.md` |
...
| 17 | Complete app-classification management in Settings | active | Learned-rule reset lane `codex/gaming-unlock-settings` | `ZC-045-015`; owned files are review rule reset service/controller/UI, focused tests, candidate evidence, and isolated claim/handoff rows |
