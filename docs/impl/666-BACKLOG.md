...
| 7 | Finish notification permission and Today fallback UX | active | Notification recovery lane `codex/notification-permission-recovery` | `ZC-004-002`, `ZC-004-004`, `ZC-050-002`, `ZC-050-005`, and `ZC-050-007`; owned files are notification health/service/coordinator/ledger and focused tests only |
