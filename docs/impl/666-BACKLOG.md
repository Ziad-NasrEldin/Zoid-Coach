...
| 12 | Complete Today source-health and repair actions | active | Source repair guidance lane `codex/today-source-repair-actions` | `ZC-048-008` and `ZC-048-009`; owned files are source-row impact/repair presentation, pure guidance model, focused tests, and candidate evidence |
