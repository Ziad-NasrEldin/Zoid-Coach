...
| 14 | Complete daily-plan task lifecycle | active | Custom estimate lane `codex/task-reschedule-confirmation` | `ZC-011-006` and `ZC-011-007`; owned files are plan estimate input/validation, focused tests, candidate evidence, and isolated claim/handoff rows |
