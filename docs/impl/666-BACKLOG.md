...
| 11 | Complete first-plan preview, edit, install, and conflict recovery | active | Plan preview metrics lane `codex/onboarding-complete-journey` | `ZC-008-005` and `ZC-008-006`; owned files are planning-capacity presentation/state, focused tests, and candidate evidence only |
