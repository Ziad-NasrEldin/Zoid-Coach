...
| 9 | Complete gaming-policy onboarding and runtime enforcement | active | Gaming observation mode lane `codex/gaming-observation-mode` | `ZC-029-001`; owned files are Gaming Policy/status, Settings toggle/draft/conflict, Today factual presentation, drift suppression, focused tests, and candidate evidence |
