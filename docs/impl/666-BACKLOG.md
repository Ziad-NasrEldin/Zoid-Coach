...
| 6 | Finish Screenwatch healthy, invalid, alternate-folder, denial, and repair UX | active | Screenwatch recovery lane `codex/screenwatch-recovery` | `ZC-003-002` through `ZC-003-004` and `ZC-003-006` through `ZC-003-009`: healthy, invalid, alternate-folder, denial, foreground repair, privacy copy, and ambiguous-analysis policy |
