...
| 7 | Finish notification permission and Today fallback UX | verify | Notification recovery candidate at `0d6ec2d` | `ZC-004-002`, `ZC-004-004`, `ZC-050-002`, `ZC-050-005`, and `ZC-050-007`; denied fallback, repair, replacement, and exactly-once response proof passed in `.audit/runs/notification-permission-recovery/0d6ec2d/REPORT.md` |
